...
const exportWindows = ({setOpenOptionMenu, screenshotsWait}) => {
	const menuClose = () => {
		setOpenOptionMenu({
			name: '',
			open: false
	...
	return (
		<div className="exportWindow">
					...
					<h3>Share Your product creation</h3>
						<div>
							...
							<div onClick={downloadImage}>
								<a className='downloadLink' href="#" download>Download 4 views</a>
				...
				<div className="menuImageToShare">
					...
					<img className="menuImageToShare_leftPosition" src={screenshotsWait.arrayScreen[1]} alt="left Position helmet"/>
					<img className="menuImageToShare_frontPosition" src={screenshotsWait.arrayScreen[2]} alt="front Position helmet"/>
					<img className="menuImageToShare_backPosition" src={screenshotsWait.arrayScreen[3]} alt="back Position helmet"/>
				</div>
			</div>
	)
}
