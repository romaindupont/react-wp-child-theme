...
const exportWindows = ({setOpenOptionMenu}) => {
	const menuClose = () => {
		setOpenOptionMenu({
			name: '',
			open: false
	...
	return (
		<div className="exportWindow">
				...
				<div className="menuImageToShare">
					<img className="menuImageToShare_quarterPosition" src={ImageHelmet} alt="quarter Position helmet"/>
					<img className="menuImageToShare_leftPosition" src={ImageHelmet} alt="left Position helmet"/>
					<img className="menuImageToShare_frontPosition" src={ImageHelmet} alt="front Position helmet"/>
					<img className="menuImageToShare_backPosition" src={ImageHelmet} alt="back Position helmet"/>
				</div>
			</div>
	)
}
