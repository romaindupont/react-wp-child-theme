const PatternShellPlain = () => {
	return (
		<svg version="1.1" id="shell_plain"	viewBox="0 0 60 60">
			<g>
				<path className="shell_plain_st0" d="M49.6,57.5c2.9-3.7,5.4-7.6,7.2-12.2c2-5.1,3.2-11.1,2.7-16.6c-0.5-5.5-2.5-10.4-5.5-14.5
					...
					L49.6,57.5z"/>
				<path className="shell_plain_st1" d="M49.6,58.6l-1.6,0l-0.8,0l-8.7,0.1l-6.6,0l-3.4,0l-3.5-0.1l-4.4-0.2l-2.3-0.2L16.7,58l-0.9-0.1l-1.4-0.3
				...
				<circle className="shell_plain_st0" cx="14.4" cy="48.4" r="1.8"/>
				<circle className="shell_plain_st0" cx="20.7" cy="44.3" r="1.8"/>
			</g>
		</svg>
	)
}

export default PatternShellPlain;