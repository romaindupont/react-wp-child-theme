const PatternShellVertical = () => {
	return (
		<svg version="1.1" id="shell_vertical" viewBox="0 0 60 60">
			<g>
				<path className="shell_vertical_st0" d="M1.1,14.8L1.1,14.8L1.1,14.8L1.1,14.8L1.1,14.8l0.1,0.1l0.1,0l0,0l0,0l0,0l0,0l0,0l0.1,0l0.1,0.1l0.1,0.1
				...
				<path className="shell_vertical_st1" d="M10,53.8l0.7,0.6l0.6,0.4l0.6,0.4l0.6,0.4l0.6,0.3l2.8,0.8l1.5,0.2l1.5,0.2l1.5,0.1l1.6,0.1l1.6,0.1l0.5,0
					l1.1,0l3.2,0.1l3.2,0l3.2,0l3,0l2.8,0l1.3,0l0,0l1.3,0l2.2,0l0.7,0l1.1,0l0.3,0l0.3,0l0.5,0l0.8,0l0.5,0l0.2,0
					c2.9-3.7,5.4-7.6,7.2-12.2c2-5.1,3.2-11.1,2.7-16.6c-0.5-5.5-2.5-10.4-5.5-14.5c-1.6-2.2-3.5-4.2-5.5-5.8L10,53.8z"/>
				<circle className="shell_vertical_st0" cx="20.7" cy="44.3" r="1.8"/>
				<circle className="shell_vertical_st0" cx="14.4" cy="48.4" r="1.8"/>
				<path className="shell_vertical_st1" d="M49.6,58.6l-1.6,0l-0.8,0l-8.7,0.1l-6.6,0l-3.4,0l-3.5-0.1l-4.4-0.2l-2.3-0.2L16.7,58l-0.9-0.1l-1.4-0.3
...
export default PatternShellVertical;