const PatternChinPlain = () => {
	return (
		<svg version="1.1" id="chin_plain"	viewBox="0 0 50 21">
			<g>
				<path className="chin_plain_st0" d="M4.7,18.9C3.6,14.1,3.3,9,3.9,4c0-0.6,0.7-1.2,1.3-1.1l0.6,0l0.7,0l1.1,0l0.8,0l0.9,0l1,0l2.1,0l2.3,0l2,0
					...
					L4.7,18.9z"/>
				<path className="chin_plain_st1" d="M27.3,0.8H5.9c-0.5-0.1-1.1,0.5-1,1c0,0.5,0.2,1.1,0.4,1l0.6,0l0.7,0l1.1,0l0.8,0l0.9,0l1,0l2.1,0l2.3,0l2,0
					l0.4,0l0.4,0l0.5,0l0.5,0l0.5,0l0.9,0l0.9,0l1.9,0l0.2,0l0.2,0l0.2,0l0.2,0l0.5-0.1l0.5-0.1L25,2.6l0.4-0.2l0.7-0.4l0.6-0.6
					l0.1-0.2l0,0L27,1.2L27.3,0.8z"/>
				<path className="chin_plain_st1" d="M33.3,17.8l-16.3,0l-12.5,0C4,17.9,3.8,18.6,4,19.2c0.1,0.5,0.7,1,1.2,0.9l11.8,0l12,0
					C30.3,20.3,32.5,19.1,33.3,17.8z"/>
				<circle className="chin_plain_st0" cx="35" cy="10.1" r="1.8"/>
				<circle className="chin_plain_st0" cx="41.3" cy="6" r="1.8"/>
			</g>
		</svg>
	)
}

export default PatternChinPlain;