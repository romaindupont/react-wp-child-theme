		...
		<>
			...
			<div className="colorList" onScroll={scrollEffect} ref={scrollRef}>
				...
				<>
					...
					<div className={standardValue.Helmet_design_color === 'green double' ? 'selectColor' : 'colorP'} onClick={() => setStandardValue({...standardValue, Helmet_design_color:'green double'})}><div className="roundColor greenDouble"></div><span className="textAction">{traduction.GreenDouble}</span></div>
					...
					<div className={standardValue.Helmet_design_color === 'vermillion' ? 'selectColor' : 'colorP'} onClick={() => setStandardValue({...standardValue, Helmet_design_color:'vermillion'})}><div className="roundColor vermillion"></div><span className="textAction">{traduction.Vermillion}</span></div>
