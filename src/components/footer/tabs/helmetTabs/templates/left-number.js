		...
		<>
			...
			<div className={leftNumberWindow ? "openColorList" : "openColorClose"}>
					<div className="colorListType">
						...
						<span className={leftNumberInput.numberColorType === 'gilding' ? 'selectButton' : 'buttonChoice'} onClick={() => setLeftNumberInput({...leftNumberInput, numberColorType:'gilding'})}>{traduction.Gilding}</span>
					</div>
