...
const MainColor = ({setStandardValue, standardValue, traduction, mySku, setMySku}) => {
	...
	return (
		...
		<div className="colorListType">
			...
			<span className={standardValue.Helmet_color_type === 'gilding' ? 'selectButton' : 'buttonChoice'} onClick={() => setStandardValue({...standardValue, Helmet_color_type:'gilding', Helmet_color:'copper foil'}) & setMySku({...mySku, position4: 'xx'})}>{traduction.Gilding}</span>
		</div>
		<div className="colorList" onScroll={scrollEffect} ref={scrollRef}>
			...
			<>
				...
				<div className={standardValue.Helmet_color === 'double cream' ? 'selectColor' : 'colorP'} onClick={() => setStandardValue({...standardValue, Helmet_color:'double cream'})}><div className="roundColor doubleCream"></div><span className="textAction">{traduction.DoubleCream}</span></div>
				<div className={standardValue.Helmet_color === 'rally blue' ? 'selectColor' : 'colorP'} onClick={() => setStandardValue({...standardValue, Helmet_color:'rally blue'})}><div className="roundColor rallyBlue"></div><span className="textAction">{traduction.RallyBlue}</span></div>
				...
				<div className={standardValue.Helmet_color === 'green doodle' ? 'selectColor' : 'colorP'} onClick={() => setStandardValue({...standardValue, Helmet_color:'green doodle'})}><div className="roundColor greenDouble"></div><span className="textAction">{traduction.GreenDouble}</span></div>
				...
				<div className={standardValue.Helmet_color === 'plum purple' ? 'selectColor' : 'colorP'} onClick={() => setStandardValue({...standardValue, Helmet_color:'plum purple'})}><div className="roundColor plumPurple"></div><span className="textAction">{traduction.PlumPurple}</span></div>
