...
const Trim = ({setStandardValue, standardValue}) => {
	return (
		<div className="varnishList">
			<div className="allScrew" onClick={()=>setStandardValue({...standardValue, Chinguard_trim:'leather_black'})}>
				<TrimBlackLeather />
				<span className="textAction">Black Leather</span>
			</div>
			<div className="allScrew"  onClick={()=>setStandardValue({...standardValue, Chinguard_trim:'rubber_black'})}>
				<TrimBlackRubber />
				<span className="textAction">Black Rubber</span>
			</div>
			<div className="allScrew"  onClick={()=>setStandardValue({...standardValue, Chinguard_trim:'leather_brown'})}>
				<TrimBrownLeather />
				<span className="textAction">Brown Leather</span>
			</div>
			<div className="allScrew"  onClick={()=>setStandardValue({...standardValue, Chinguard_trim:'rubber_white'})}>
				<TrimWhiteRubber />
